...
namespace BahiKitab.Services
{
    public abstract class BaseDataService
    {
        ...
        public BaseDataService()
        {
            ...
            _connectionString = "Server=82.29.166.165;Port=3306;Uid=root;Pwd=sofricdev;database=bahikitabdev";
#endif
#if RELEASE

            //_connectionString = "Server=192.168.1.90;Uid=cosdb;Pwd=Cosmetify@123;database=cosmetify";
            _connectionString = "Server=82.29.166.165;Port=3307;Uid=root;Pwd=sofricprod;database=bahikitabprod";
#endif
#if TESTING
